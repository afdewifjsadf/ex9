...
//            double gpa = Double.parseDouble(request.getParameter("gpa"))
            ...
            if(listId.contains(idStr)){
             out.println("<!DOCTYPE html>");
                ...
                out.println("<h2>Insert : " + idStr + "</h2>");
            ...
            synchronized (getServletContext()) {
                ...
                String result = db.insertStudent((Student) getServletContext().getAttribute("std"));
                out.println("<!DOCTYPE html>");
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet insertServlet</title>");
                ...
                out.println("<body>");
                out.println("<h1>Servlet insertServlet </h1>");
                out.println("<h2>Insert : " + getServletContext().getAttribute("id") + "</h2>");
